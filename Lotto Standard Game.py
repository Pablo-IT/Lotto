...
nr = 0
while nr < 6:
    user_drawn = int(input('Please type a number from 1 to 49:'))
...
userp = 1/(probability_count / probability_to_draw)
userp = '{:.2%}'.format(userp)

#Print results
print('Probability of drawing a six is 1 to', probability)
